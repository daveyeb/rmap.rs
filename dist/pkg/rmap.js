import { startWorkers } from './snippets/wasm-bindgen-rayon-7afa899f36665473/src/worker.js';
...
* @returns {any}
*/
export function parse_blobs(blobs) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.parse_blobs(retptr, addHeapObject(blobs));
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_e5d6475c873bc1b4 = function(arg0, arg1) {
...
async function __wbg_init(input, maybe_memory) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('rmap_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
